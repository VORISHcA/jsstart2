...
const all_product = document.querySelector(".products");
const all_button = document.querySelectorAll("button");
all_button.forEach(function (button) {
...
function showCategory(category) {
    const categorypr = products[category];
    let markin = "";
    categorypr.forEach(function (product) {
        markin += getProductMarkup(product);
    });
    all_product.insertAdjacentHTML("afterbegin", markupToProductsDiv);
}
